...
class DoubleStreamBlock(nn.Module):
    ...
    def forward(
        ...
        img_q, img_k, img_v = rearrange(img_qkv, "B L (K H D) -> K B H L D", K=3, H=self.num_heads, D=self.head_dim)
        ...
        txt_q, txt_k, txt_v = rearrange(txt_qkv, "B L (K H D) -> K B H L D", K=3, H=self.num_heads, D=self.head_dim)
